...
// Simple cn helper (replace with your utils if needed)
...
export const BackgroundBeamsWithCollision: React.FC<BackgroundBeamsProps> = ({
  ...
  return (
    <div
      ref={parentRef}
      className={cn(
        "relative flex items-center justify-center w-full overflow-hidden bg-gradient-to-b from-white to-neutral-100 dark:from-neutral-950 dark:to-neutral-800",
        className
      )}
    >
      {beams.map((beam, idx) => (
      ...
      <div
        ref={containerRef}
        className="absolute bottom-0 w-full inset-x-0 pointer-events-none bg-neutral-100"
        style={{
          boxShadow:
